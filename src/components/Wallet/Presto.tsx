    ...
    return (
        <div className='w-full flex '>
            <div className='w-1/2  h-full'>
                ...
                <div className='w-full px-6 md:px-10 lg:px-22 pt-0 pb-12 lg:pt-22 lg:pb-22 text-4xl md:text-5xl lg:text-7xl font-medium lg:font-semibold overflow-visible'>
                    <ScrollReveal>
            ...
            <div className='w-1/2 flex '>
                ...
                <div className='w-10/12 h-full '>
                    ...
                    <div className='h-full mx-auto '>
                        <div className='lg:h-106 lg:w-106 w-36 h-37 md:w-56 md:h-56 mx-auto bg-gray-800 rounded-3xl lg:rounded-4xl flex justify-center pt-1 lg:pt-6 overflow-hidden'>
