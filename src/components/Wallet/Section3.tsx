...
function Section3() {
    return (
        <div className={`bg-gray-900 w-full ${futura.className} md:px-4 lg:px-0 space-y-8 lg:space-y-12 text-xl md:text-4xl lg:text-5xl`}>
            <div>
                <div className='p-1 border-4 border-[#4994C4] rounded-full w-10 lg:w-16 mt-4 lg:mt-0'>
