...
function FlightAnimationMobile() {
    return (
        <div className='lg:flex py-8 lg:py-0 bg-[#f3f4f6] rounded-4xl'>
            <div className='w-full lg:w-1/2 text-3xl md:text-5xl lg:text-7xl px-6 lg:px-0 lg:pl-12 lg:pr-22 flex justify-center items-end lg:pb-32 pt-4 pb-0 lg:py-0 text-gray-50'>
                <div>
                    <ScrollReveal>
