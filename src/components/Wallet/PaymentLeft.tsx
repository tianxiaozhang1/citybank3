...
function PaymentLeft() {
    return (
        <div className=''>
            ...
            <div className='px-4 py-6 flex bg-gray-50 text-gray-700 text-lg rounded-3xl mt-8 lg:mt-12 shadow-md'>
                ...
                <div className='flex justify-between w-4/6 '>
                    <div className='pl-2'>
                        <div className='lg:-mb-1 text-base lg:text-base'>Klarna</div>
                        <div className='border-2 border-gray-300 rounded-lg px-1.5 text-xs lg:text-sm'>Pay Later</div>
                    </div>
            ...
            <div className='px-4 py-6 flex bg-gray-50 text-gray-700 text-lg rounded-3xl mt-2 shadow-md'>
                ...
                <div className='w-4/6 pl-2 text-base lg:text-base'>
