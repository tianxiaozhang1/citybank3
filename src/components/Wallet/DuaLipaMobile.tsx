...
function DuaLipaMobile() {
    return (
        <div className='lg:flex pt-8 bg-gray-950 rounded-4xl'>
            <div className='w-full text-3xl md:text-5xl px-6 flex justify-center items-end pt-4 pb-0  text-gray-50'>
                <div>
                    <ScrollReveal>
                        <div className={`text-[#6d8c3f] ${futura.className} text-center font-medium px-2`}>
